...
// const logoBlob = new Blob([logoPath], { type: "image/png" });
...
export const Content00DataSource = {
  ...
  titleWrapper: {
    ...
    children: [{ name: 'title', children: '主要功能' }],
  },
  childWrapper: {
    ...
    children: [
      {
        ...
        children: {
          ...
          children: [
            ...
            { name: 'content', children: '一键为素材自动标签, 标签翻译, 标签别名' },
          ],
        },
      },

      {
        ...
        children: {
          ...
          children: [
            ...
            { name: 'content', children: '支持标签多父级结构, 标签别名, 标签注解' },
          ],
        },
      },

      {
        ...
        children: {
          ...
          children: [
            ...
            { name: 'content', children: '支持多种条件的高级搜索, 直观查看' },
          ],
        },
      },
